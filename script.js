...
const ultraSunMoonData = {
  monday: [
    { island: "🏝️ Mele-Mele", pokemon: [{ level: 12, id: 7 }] },
    { island: "🌺 Akala", pokemon: [{ level: 19, id: 363 }] },
    { island: "🌋 Ula-Ula", pokemon: [{ level: 33, id: 220 }] },
    { island: "🏔️ Poni", pokemon: [{ level: 57, id: 306 }] },
  ],
  tuesday: [
    { island: "🏝️ Mele-Mele", pokemon: [{ level: 14, id: 95 }] },
    { island: "🌺 Akala", pokemon: [{ level: 20, id: 256 }] },
    { island: "🌋 Ula-Ula", pokemon: [{ level: 35, id: 394 }] },
    { island: "🏔️ Poni", pokemon: [{ level: 61, id: 479 }] },
  ],
  wednesday: [
    { island: "🏝️ Mele-Mele", pokemon: [{ level: 18, id: 116 }] },
    { island: "🌺 Akala", pokemon: [{ level: 24, id: 679 }] },
    { island: "🌋 Ula-Ula", pokemon: [{ level: 36, id: 388 }] },
    { island: "🏔️ Poni", pokemon: [{ level: 57, id: 542 }] },
  ],
  thursday: [
    { island: "🏝️ Mele-Mele", pokemon: [{ level: 9, id: 664 }] },
    { island: "🌺 Akala", pokemon: [{ level: 14, id: 15 }] },
    { island: "🌋 Ula-Ula", pokemon: [{ level: 29, id: 18 }] },
    { island: "🏔️ Poni", pokemon: [{ level: 45, id: 652 }] },
  ],
  friday: [
    { island: "🏝️ Mele-Mele", pokemon: [{ level: 10, id: 1 }] },
    { island: "🌺 Akala", pokemon: [{ level: 16, id: 253 }] },
    { island: "🌋 Ula-Ula", pokemon: [{ level: 29, id: 391 }] },
    { island: "🏔️ Poni", pokemon: [{ level: 44, id: 658 }] },
  ],
  saturday: [
    { island: "🏝️ Mele-Mele", pokemon: [{ level: 9, id: 607 }] },
    { island: "🌺 Akala", pokemon: [{ level: 17, id: 259 }] },
    { island: "🌋 Ula-Ula", pokemon: [{ level: 30, id: 610 }] },
    { island: "🏔️ Poni", pokemon: [{ level: 44, id: 655 }] },
  ],
  sunday: [
    { island: "🏝️ Mele-Mele", pokemon: [{ level: 12, id: 4 }] },
    { island: "🌺 Akala", pokemon: [{ level: 17, id: 280 }] },
    { island: "🌋 Ula-Ula", pokemon: [{ level: 32, id: 111 }] },
    { island: "🏔️ Poni", pokemon: [{ level: 55, id: 604 }] },
  ],
};
...
const sunMoonData = {
  monday: [
    { island: "🏝️ Mele-Mele", pokemon: [{ level: 12, id: 158 }] },
    { island: "🌺 Akala", pokemon: [{ level: 19, id: 363 }] },
    { island: "🌋 Ula-Ula", pokemon: [{ level: 31, id: 220 }] },
    { island: "🏔️ Poni", pokemon: [{ level: 57, id: 534 }] },
  ],
  tuesday: [
    { island: "🏝️ Mele-Mele", pokemon: [{ level: 13, id: 633 }] },
    { island: "🌺 Akala", pokemon: [{ level: 20, id: 404 }] },
    { island: "🌋 Ula-Ula", pokemon: [{ level: 33, id: 578 }] },
    { island: "🏔️ Poni", pokemon: [{ level: 59, id: 468 }] },
  ],
  wednesday: [
    { island: "🏝️ Mele-Mele", pokemon: [{ level: 18, id: 116 }] },
    { island: "🌺 Akala", pokemon: [{ level: 23, id: 679 }] },
    { island: "🌋 Ula-Ula", pokemon: [{ level: 34, id: 315 }] },
    { island: "🏔️ Poni", pokemon: [{ level: 57, id: 542 }] },
  ],
  thursday: [
    { island: "🏝️ Mele-Mele", pokemon: [{ level: 8, id: 599 }] },
    { island: "🌺 Akala", pokemon: [{ level: 14, id: 543 }] },
    { island: "🌋 Ula-Ula", pokemon: [{ level: 27, id: 397 }] },
    { island: "🏔️ Poni", pokemon: [{ level: 43, id: 497 }] },
  ],
  friday: [
    { island: "🏝️ Mele-Mele", pokemon: [{ level: 10, id: 152 }] },
    { island: "🌺 Akala", pokemon: [{ level: 16, id: 69 }] },
    { island: "🌋 Ula-Ula", pokemon: [{ level: 27, id: 288 }] },
    { island: "🏔️ Poni", pokemon: [{ level: 43, id: 503 }] },
  ],
  saturday: [
    { island: "🏝️ Mele-Mele", pokemon: [{ level: 10, id: 607 }] },
    { island: "🌺 Akala", pokemon: [{ level: 17, id: 183 }] },
    { island: "🌋 Ula-Ula", pokemon: [{ level: 28, id: 610 }] },
    { island: "🏔️ Poni", pokemon: [{ level: 43, id: 500 }] },
  ],
  sunday: [
    { island: "🏝️ Mele-Mele", pokemon: [{ level: 12, id: 155 }] },
    { island: "🌺 Akala", pokemon: [{ level: 17, id: 574 }] },
    { island: "🌋 Ula-Ula", pokemon: [{ level: 30, id: 111 }] },
    { island: "🏔️ Poni", pokemon: [{ level: 55, id: 604 }] },
  ],
};
...
const dailyLocations = {
  monday: [
    { island: "🏝️ Mele-Mele", location: "Meereshöhle" },
    { island: "🌺 Akala", location: "Route 7" },
    { island: "🌋 Ula-Ula", location: "Dorf der Kapu" },
    { island: "🏔️ Poni", location: "Ebene von Poni" },
  ],
  tuesday: [
    { island: "🏝️ Mele-Mele", location: "Tenkarat-Hügel" },
    { island: "🌺 Akala", location: "Route 8" },
    { island: "🌋 Ula-Ula", location: "Route 16" },
    { island: "🏔️ Poni", location: "Beschwerlicher Pfad" },
  ],
  wednesday: [
    { island: "🏝️ Mele-Mele", location: "Kala'e-Bucht" },
    { island: "🌺 Akala", location: "Akala-Küstenstreifen" },
    { island: "🌋 Ula-Ula", location: "Ula-Ula-Blumenmeer" },
    { island: "🏔️ Poni", location: "Poni-Blumenmeer" },
  ],
  thursday: [
    { island: "🏝️ Mele-Mele", location: "Hauholi City" },
    { island: "🌺 Akala", location: "Route 4" },
    { island: "🌋 Ula-Ula", location: "Route 10" },
    { island: "🏔️ Poni", location: "Kokowei-Eiland" },
  ],
  friday: [
    { island: "🏝️ Mele-Mele", location: "Route 2" },
    { island: "🌺 Akala", location: "Route 5" },
    { island: "🌋 Ula-Ula", location: "Route 11" },
    { island: "🏔️ Poni", location: "Wildnis von Poni" },
  ],
  saturday: [
    { island: "🏝️ Mele-Mele", location: "Hauholi-Friedhof" },
    { island: "🌺 Akala", location: "Plätscherhügel" },
    { island: "🌋 Ula-Ula", location: "Hokulani-Berg" },
    { island: "🏔️ Poni", location: "Alter Pfad von Poni" },
  ],
  sunday: [
    { island: "🏝️ Mele-Mele", location: "Route 3" },
    { island: "🌺 Akala", location: "Route 6" },
    { island: "🌋 Ula-Ula", location: "Glühberg" },
    { island: "🏔️ Poni", location: "Wald von Poni" },
  ],
};
...
async function displayTodaysPokemon() {
  ...
  const footerText =
    currentVersion === "ultra"
      ? "Daten für Pokémon Ultra Sonne & Ultra Mond"
      : "Daten für Pokémon Sonne & Mond";
